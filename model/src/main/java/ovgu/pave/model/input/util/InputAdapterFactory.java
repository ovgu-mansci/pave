...
public class InputAdapterFactory extends AdapterFactoryImpl {
	...
	protected InputSwitch<Adapter> modelSwitch =
		new InputSwitch<Adapter>() {
			...
			@Override
			public Adapter caseFirstRequestActivity(FirstRequestActivity object) {
				return createFirstRequestActivityAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseSecondRequestActivity(SecondRequestActivity object) {
				return createSecondRequestActivityAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link ovgu.pave.model.input.FirstRequestActivity <em>First Request Activity</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createFirstRequestActivityAdapter() {
		return null;
	}
	...
	/**
	 * Creates a new adapter for an object of class '{@link ovgu.pave.model.input.SecondRequestActivity <em>Second Request Activity</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createSecondRequestActivityAdapter() {
		return null;
	}
