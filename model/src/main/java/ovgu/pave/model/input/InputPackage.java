...
public interface InputPackage extends EPackage {
	...
	/**
	 * The feature id for the '<em><b>Pre Rejected</b></em>' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int REQUEST__PRE_REJECTED = 5;

	/**
	 * The feature id for the '<em><b>Penaltie</b></em>' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int REQUEST__PENALTIE = 6;
	 ...
	 * @ordered
	 */
	int FIRST_REQUEST_ACTIVITY__EARLIEST_ARRIVAL = REQUEST_ACTIVITY__EARLIEST_ARRIVAL;
	 ...
	 * @ordered
	 */
	int FIRST_REQUEST_ACTIVITY_FEATURE_COUNT = REQUEST_ACTIVITY_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int SECOND_REQUEST_ACTIVITY__EARLIEST_ARRIVAL = REQUEST_ACTIVITY__EARLIEST_ARRIVAL;
	...
	/**
	 * Returns the meta object for the attribute '{@link ovgu.pave.model.input.Request#isPreRejected <em>Pre Rejected</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Pre Rejected</em>'.
	 * @see ovgu.pave.model.input.Request#isPreRejected()
	 * @see #getRequest()
	 * @generated
	 */
	EAttribute getRequest_PreRejected();

	/**
	 * Returns the meta object for the attribute '{@link ovgu.pave.model.input.Request#getPenaltie <em>Penaltie</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Penaltie</em>'.
	 * @see ovgu.pave.model.input.Request#getPenaltie()
	 * @see #getRequest()
	 * @generated
	 */
	EAttribute getRequest_Penaltie();
	...
	/**
	 * Returns the meta object for the attribute '{@link ovgu.pave.model.input.Vehicle#getLatestArrival <em>Latest Arrival</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Latest Arrival</em>'.
	 * @see ovgu.pave.model.input.Vehicle#getLatestArrival()
	 * @see #getVehicle()
	 * @generated
	 */
	EAttribute getVehicle_LatestArrival();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Pre Rejected</b></em>' attribute feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EAttribute REQUEST__PRE_REJECTED = eINSTANCE.getRequest_PreRejected();

		/**
		 * The meta object literal for the '<em><b>Penaltie</b></em>' attribute feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EAttribute REQUEST__PENALTIE = eINSTANCE.getRequest_Penaltie();
		 ...
		 * @generated
		 */
		EAttribute VEHICLE__LATEST_ARRIVAL = eINSTANCE.getVehicle_LatestArrival();
