 ...
 *   <li>{@link ovgu.pave.model.input.impl.VehicleImpl#getLatestArrival <em>Latest Arrival</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VehicleImpl extends MinimalEObjectImpl.Container implements Vehicle {
	...
	public void setLatestArrival(long newLatestArrival) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InputPackage.VEHICLE__LATEST_ARRIVAL, oldLatestArrival, latestArrival));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case InputPackage.VEHICLE__LATEST_ARRIVAL:
