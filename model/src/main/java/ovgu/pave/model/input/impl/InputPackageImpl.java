...
public class InputPackageImpl extends EPackageImpl implements InputPackage {
	 ...
	 * @generated
	 */
	public EAttribute getRequest_PreRejected() {
	 ...
	 * @generated
	 */
	public EAttribute getRequest_Penaltie() {
	 ...
	 * @generated
	 */
	public EAttribute getVehicle_LatestArrival() {
	...
	public void createPackageContents() {
		...
		createEAttribute(requestEClass, REQUEST__PRE_REJECTED);
		createEAttribute(requestEClass, REQUEST__PENALTIE);
		...
		createEAttribute(vehicleEClass, VEHICLE__LATEST_ARRIVAL);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getRequest_PreRejected(), ecorePackage.getEBoolean(), "preRejected", null, 0, 1, Request.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRequest_Penaltie(), ecorePackage.getEInt(), "penaltie", null, 0, 1, Request.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getVehicle_LatestArrival(), ecorePackage.getELong(), "latestArrival", null, 0, 1, Vehicle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
