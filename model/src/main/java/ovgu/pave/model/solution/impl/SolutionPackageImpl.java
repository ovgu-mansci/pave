...
public class SolutionPackageImpl extends EPackageImpl implements SolutionPackage {
	 ...
	 * @generated
	 */
	public EOperation getRoute__GetElement__int() {
	...
	public void createPackageContents() {
		...
		createEOperation(routeEClass, ROUTE___GET_ELEMENT__INT);
	...
	public void initializePackageContents() {
		...
		EOperation op = initEOperation(getRoute__GetElement__int(), this.getRouteElement(), "getElement", 0, 1, IS_UNIQUE, IS_ORDERED);
