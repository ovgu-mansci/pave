...
public interface SolutionPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int ROUTE___GET_ELEMENT__INT = 0;
	...
	/**
	 * Returns the meta object for the '{@link ovgu.pave.model.solution.Route#getElement(int) <em>Get Element</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Get Element</em>' operation.
	 * @see ovgu.pave.model.solution.Route#getElement(int)
	 * @generated
	 */
	EOperation getRoute__GetElement__int();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EOperation ROUTE___GET_ELEMENT__INT = eINSTANCE.getRoute__GetElement__int();
