...
public class ConfigFactoryImpl extends EFactoryImpl implements ConfigFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case ConfigPackage.ALNS: return createALNS();
			case ConfigPackage.LMNS: return createLMNS();
			case ConfigPackage.ORTOOLS: return createORTOOLS();
			case ConfigPackage.OFFLINE: return createOffline();
			case ConfigPackage.ONLINE: return createOnline();
			default:
	 ...
	 * @generated
	 */
	public ALNS createALNS() {
		ALNSImpl alns = new ALNSImpl();
		return alns;
	}
	 ...
	 * @generated
	 */
	public LMNS createLMNS() {
		LMNSImpl lmns = new LMNSImpl();
		return lmns;
	}
	 ...
	 * @generated
	 */
	public ORTOOLS createORTOOLS() {
		ORTOOLSImpl ortools = new ORTOOLSImpl();
		return ortools;
	}
