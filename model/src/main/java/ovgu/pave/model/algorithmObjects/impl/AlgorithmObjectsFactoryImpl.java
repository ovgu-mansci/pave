...
public class AlgorithmObjectsFactoryImpl extends EFactoryImpl implements AlgorithmObjectsFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case AlgorithmObjectsPackage.SEARCH_STATISTICS: return createSearchStatistics();
			...
			case AlgorithmObjectsPackage.REMOVAL_INFORMATION: return createRemovalInformation();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			...
			case AlgorithmObjectsPackage.REUQESTS_HASH_MAP:
				return createReuqestsHashMapFromString(eDataType, initialValue);
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			...
			case AlgorithmObjectsPackage.REUQESTS_HASH_MAP:
				return convertReuqestsHashMapToString(eDataType, instanceValue);
			case AlgorithmObjectsPackage.REQUESTS:
	...
	public SearchStatistics createSearchStatistics() {
		SearchStatisticsImpl searchStatistics = new SearchStatisticsImpl();
	 ...
	 * @generated
	 */
	public RemovalInformation createRemovalInformation() {
		RemovalInformationImpl removalInformation = new RemovalInformationImpl();
		return removalInformation;
	}
	...
	public HashMap<Request, Long> createReuqestsHashMapFromString(EDataType eDataType, String initialValue) {
	 ...
	 * @generated
	 */
	public String convertReuqestsHashMapToString(EDataType eDataType, Object instanceValue) {
