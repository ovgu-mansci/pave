...
public class InputHandlerTests extends TestCase {
	...
	public void test_findRequestActivity() {
		...
		assertEquals(r2.getSecondActivity(), iH.findAcceptedRequestActivity(r2.getSecondActivity().getId()));
		assertEquals(r7.getSecondActivity(), iH.findAcceptedRequestActivity(r7.getSecondActivity().getId()));
		assertEquals(r5.getFirstActivity(), iH.findAcceptedRequestActivity(r5.getFirstActivity().getId()));
		assertEquals(r3.getSecondActivity(), iH.findAcceptedRequestActivity(r3.getSecondActivity().getId()));
		assertEquals(r3.getFirstActivity(), iH.findAcceptedRequestActivity(r3.getFirstActivity().getId()));
		assertEquals(r6.getSecondActivity(), iH.findAcceptedRequestActivity(r6.getSecondActivity().getId()));
		assertEquals(r6.getFirstActivity(), iH.findAcceptedRequestActivity(r6.getFirstActivity().getId()));
	...
	public void test_createRequestActivity() {
		...
		FirstRequestActivity ora = InputHandler.createRequestActivity(FirstRequestActivity.class);
		SecondRequestActivity dra = InputHandler.createRequestActivity(SecondRequestActivity.class);
		...
		assertTrue(InputHandler.isFirstRequestActivity(ora));
		assertTrue(InputHandler.isSecondRequestActivity(dra));

		assertFalse(InputHandler.isFirstRequestActivity(ra));
		assertFalse(InputHandler.isSecondRequestActivity(ra));
		assertFalse(InputHandler.isSecondRequestActivity(ora));
		assertFalse(InputHandler.isFirstRequestActivity(dra));
