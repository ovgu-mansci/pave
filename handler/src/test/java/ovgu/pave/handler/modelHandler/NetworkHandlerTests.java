...
public class NetworkHandlerTests extends TestCase {
	...
	public void test_getEdge_withRouteElementensWithoutWayPoints() {
		...
		RouteElement rE1 = SolutionHandler.createRequestActivityRouteElement(InputHandler.createRequestActivity(FirstRequestActivity.class));
		...
		RouteElement rE3 = SolutionHandler.createRequestActivityRouteElement(InputHandler.createRequestActivity(SecondRequestActivity.class));
	...
	public void test_getEdge_withRequestActivity() {
		...
		RequestActivity rA1 = InputHandler.createRequestActivity(FirstRequestActivity.class);
		rA1.setLocation(l1);
		RequestActivity rA2 = InputHandler.createRequestActivity(SecondRequestActivity.class);
		rA2.setLocation(l2);
